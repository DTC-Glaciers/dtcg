...
from dtcg.validation.sentinel_validation import (validate_with_sentinel,
                                                 plot_sentinel)
from dtcg.validation.annual_mb_validation import (validate_with_annual_mb,
                                                  plot_annual_mb)
    ...
    def __init__(self, datatree):
        ...
        self.supported_obs_for_validation = {
            'WGMS': {'fct': validate_with_wgms,
                     'label': 'L1 WGMS annual mass balance'},
        ...
        self.supported_user_obs = {
            'annual_mb': {'fct': validate_with_annual_mb,
        ...
        for l2_name in l2_name_list:
            ...
            if user_observation is None:
                ...
                for obs in obs_list:
                    ...
                    add_result_to_dicts(validation_tmp=validation_tmp,
                                        obs=obs,

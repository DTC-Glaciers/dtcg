...
def validate_with_annual_mb(
    ...
    **kwargs,
    ...
    results = bootstrap_metric_obs_normal_mdl_quantiles(
        ...
        metrics=[supported_metrics[metric]["fct_name"] for metric in supported_metrics],
        **kwargs,
    )
...
def plot_annual_mb(observation, datatree, l2_name_list):
    if observation["obs_type"] != "annual_mb":
        raise ValueError(
            "The provided observation need to be from type 'annual_mb', "
